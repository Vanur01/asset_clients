// components/TeamManagement/AddMemberModal.jsx
...
const AddMemberModal = ({ open, onClose, onSubmit, loading }) => {
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        ...
        <DialogActions sx={{ px: { xs: 2, sm: 2.5 }, pb: 2.5, gap: 1.5 }}>
          ...
          >
            {loading ? <CircularProgress size={18} sx={{ color: 'white' }} /> : 'Add Member'}
          </Button>
        </DialogActions>
      </form>
    </Dialog>
